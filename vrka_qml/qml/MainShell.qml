...
ApplicationWindow {
    ...
    // Outer Window Border for Frameless Definition
    Rectangle {
        anchors.fill: parent
        color: "transparent"
    ...
    Item {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                // DAY MODE / NIGHT MODE Capsule Toggle (ABOVE UPLINK FOOTER per Phase 12 Requirement)
                AbstractButton {
                    id: themeToggle
                ...
                // Authoritative UPLINK Telemetry Console (ANCHORED AT BOTTOM per Phase 12 Requirement)
                Rectangle {
                    Layout.fillWidth: true
                    Layout.leftMargin: 12
                    Layout.rightMargin: 12
