...
ScrollView {
    ...
    ColumnLayout {
        ...
        // Section 3: Advanced Network & Custom Headers (Collapsible Progressive Disclosure)
        Rectangle {
            Layout.fillWidth: true
            implicitHeight: headersCol.implicitHeight + (headersDetails.visible ? 24 : 16)
            radius: Theme.cardRadius
            color: Theme.card
            border.width: 1
            border.color: Theme.border
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    VSecondaryButton {
                        text: headersDetails.visible ? "Hide Options" : "Show Options"
                        Layout.preferredHeight: 28
                        onClicked: headersDetails.visible = !headersDetails.visible
                    }
                }
