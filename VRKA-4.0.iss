; VRKA 4.5 build 018 - Windows x64 installer (Inno Setup 6)
...
OutputDir=outputs\VRKA-4.5-build018-release
OutputBaseFilename=VRKA-4.5-build018-setup-Windows-x64
